...
if ($type == 'GET')
{
    ...
    $header .= "User-Agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.1 Safari/537.36\r\n";
}
else
{
    ...
    $_postData = array('body1' => 'swoole_http-server', 'message' => 'nihao');
