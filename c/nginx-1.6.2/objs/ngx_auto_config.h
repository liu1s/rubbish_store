#define NGX_CONFIGURE " --prefix=/usr/local/nginx --with-pcre --with-cc-opt=-Wno-deprecated-declarations"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "clang 6.0 (clang-600.0.56) (based on LLVM 3.5svn)"
#endif
